...
<head>
	...
	<section>
		...
		<div class="store_select">
			<div class="store_select_img">
				<img src="jomor_html/img/store2.png" alt="吉祥物圖框" title="猴子吉祥物" width="950px" height="310px">
			</div>
	...
	<!--第一行div表格-->
				            ...
				            <div class="store_info_card-0">
								<div class="store_info_card01"><!--店家資訊卡店名與圖片部分-->
									<span class="span_love_img">
										<img class="love_img" src="jomor_html/img/love.png">
									</span>
									<span class="store_name" onClick="opendiv(Store_inf)">Swancafe天鵝咖啡館</span>
				         ...
				         <div class="cell2"> <!-- td -->
				             ...
				             <div class="store_info_card-0">
								<div class="store_info_card01"><!--店家資訊卡店名與圖片部分-->
									...
									<span class="store_name" onClick="opendiv(Store_inf)">女巫店</span>
				             ...
				             <div class="store_info_card-0">
								...
								<div class="store_info_card02">
									<table class="store_info_card02_table">
										<tr>
											<td class="store_info_card02_td01">店家地址｜</td>
											<td class="store_info_p2">台北市羅斯福路五段170巷37號一樓
											</td>
										</tr>
										<tr>
											<td class="store_info_card02_td01">店家電話｜</td>
									...
									<div class="store_triangle">
										<a onmouseover="store_mouseOver3()" onmouseout="store_mouseOut3()" onClick="opendiv(Store_inf)">
											<img id="store_triangle_id03" src="jomor_html/img/store_triangle.png" height="20px" width="23px">
										</a>
									</div>
								</div>
							</div>    
				         ...
				         <div class="cell1"><!-- td -->  
				            ...
				            <div class="store_info_card-0">
								...
								<div class="store_info_card02">
									...
									<div class="store_triangle">
										<a onmouseover="store_mouseOver4()" onmouseout="store_mouseOut4()" onClick="opendiv(Store_inf)">
											<img id="store_triangle_id04" src="jomor_html/img/store_triangle.png" height="20px" width="23px">
										</a>
									</div>
								</div>
							</div>    
				         ...
				         <div class="cell2"> <!-- td -->
				             ...
				             <div class="store_info_card-0">
								...
								<div class="store_info_card02">
									...
									<div class="store_triangle">
										<a onmouseover="store_mouseOver5()" onmouseout="store_mouseOut5()" onClick="opendiv(Store_inf)">
											<img id="store_triangle_id05" src="jomor_html/img/store_triangle.png" height="20px" width="23px">
										</a>
									</div>
								</div>
							</div>    
				         ...
				         <div class="cell3"> <!-- td -->
				             ...
				             <div class="store_info_card-0">
								...
								<div class="store_info_card02">
									...
									<div class="store_triangle">
										<a onmouseover="store_mouseOver6()" onmouseout="store_mouseOut6()" onClick="opendiv(Store_inf)">
											<img id="store_triangle_id06" src="jomor_html/img/store_triangle.png" height="20px" width="23px">
										</a>
									</div>
								</div>
							</div>    
		...
		<!--側邊欄位-->
	<aside class="aside02">
		<div class="aside_p1">附近</br>店家</div>
		<div class="aside_store">
			<img class="aside_store_img" src="jomor_html/img/swancafe01.jpg" width="195px" height="195px" onClick="opendiv(Store_inf)">
		</div>
		<div class="aside_store">
			<img class="aside_store_img" src="jomor_html/img/witch.jpg" width="195px" height="195px" onClick="opendiv(Store_inf)">
		</div>
		<div class="aside_store">
			<img class="aside_store_img" src="jomor_html/img/swancafe01.jpg" width="195px" height="195px" onClick="opendiv(Store_inf)">
		</div>
