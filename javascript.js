...
function lightGrey(){
	document.getElementById('triangle').src ="../../jomor_html/img/jo_triangle2.png" 
}
function darkGrey(){
	document.getElementById('triangle').src ="../../jomor_html/img/jo_triangle.png" 
}
