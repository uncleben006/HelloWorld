	...
	<body id="body0">
		...
		<section class="essay_section">
			<div class="essay_path_div"> <!--路徑-->
				...
				<span class="path_mark">></span>
				<span><a class="path_p" href="blog_more1-9.php">化裝舞會介紹</a></span>
			</div>
				...
				<div class="essay_green_line"><!--文章綠線-->
					<div><!--文章上半部標題日期等資訊-->
						...
						<span class="essay_title_span"><!--文章標題與時間-->
							...
							<div class="essay_title_p2">2016.10.20 | 十大派對桌遊介紹 | 化裝舞會</div>
						</span>
						<!--分享區塊-->
						<span class="essay_more_share_span">
							...
							<div class="essay_more_share_bt_div">
								<!--fb分享按鈕-->
								<a href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent('http://www.jomorparty.com/blog_more1-9.php'))));">
					...
					<div class="essay_more_words">
						<span>
							<img src="jomor_html/img/blogimg/blog1/game9.png">
						</span>
						<span class="essay_more_gname_block">
							<div class="essay_more_gname">第九名：化裝舞會 MASCARADE</div>
						<hr color="#96BDD2" width="85%" size="5" align="left">
							<div class="essay_more_gp">化裝舞會是一款適合多人玩、類似吹牛的派對遊戲，且支援人數高達13人。玩家可以擅用自身角色的能力順利賺取金幣，亦或覬覦別的玩家的角色執行該能力瞞天過海。</div>
						</span>
						...
						<hr color="#96BDD2" width="120px" size="5" align="left">
							<div class="essay_more_gp">
								<p>當其中一位玩家先行獲得超過13元金幣，則遊戲結束並且獲得最多錢的玩家獲勝。</p>
							</div>
						</span>
						...
						<hr color="#96BDD2" width="140px" size="5" align="left">
							<div class="essay_more_gp">
								<p>14張角色牌(含空白角色牌)、1張法院圖版、金幣86個(包含1元*64、5元*18、10元*4)、14塊角色標記、5張玩家輔助卡</p>
							</div>
						</span>
						<!--圖片改檔名"game1-1"的部分-->
						<span class="blogimg_span">
							<img src="jomor_html/img/blogimg/blog1/game9-1.jpg" style="height: auto;width: 70%">
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gname">遊戲規則</div>
						<hr color="#96BDD2" width="30%" size="5" align="left">
							<div class="essay_more_gp">
								<p>起始設定：每位玩家從銀行拿取6元及一張角色卡。當每位玩家都拿到角色後，將角色掀開，這時候就需要記憶自己與他人的牌。確定大家都記完牌之後，再將角色牌蓋起來。
									<br>當第五回合開始，當輪到自己的回合，會有3個動作可選擇：
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. 確認自己的角色卡是什麼
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. 秘密的和其他玩家角色卡交換(或不交換)
									<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. 宣告自己的角色並使用能力(當然也可吹牛)
								</p>
							</div>
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gp">
								<p>這款遊戲過程相當刺激緊張，而且人數越多越好玩！適當的耍點小心機說不定會讓你贏得遊戲，因為支援人數多，也不用擔心人多沒辦法玩喔！
								</p>
							</div>
						</span>
					</div>
					...
					<div class="game_introduction">
						<span class="game_introduction_span">
							...
							<div class="essay_more_gp">10歲以上</div>
						</span>
						<span class="game_introduction_span">
							<div class="essay_more_gname">遊玩人數</div>
							<hr color="#5D5D5D" width="66%" size="4">
							<div class="essay_more_gp">2-13人</div>
						</span>
						<span class="game_introduction_span">
