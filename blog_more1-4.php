	...
	<body id="body0">
		...
		<section class="essay_section">
			<div class="essay_path_div"> <!--路徑-->
				...
				<span class="path_mark">></span>
				<span><a class="path_p" href="blog_more1-4.php">誰是牛頭王介紹</a></span>
			</div>
				...
				<div class="essay_green_line"><!--文章綠線-->
					<div><!--文章上半部標題日期等資訊-->
						...
						<span class="essay_title_span"><!--文章標題與時間-->
							...
							<div class="essay_title_p2">2016.10.20 | 十大派對桌遊介紹 | 誰是牛頭王</div>
						</span>
						<!--分享區塊-->
						<span class="essay_more_share_span">
							...
							<div class="essay_more_share_bt_div">
								<!--fb分享按鈕-->
								<a href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent('http://www.jomorparty.com/blog_more1-4.php'))));">
					...
					<div class="essay_more_words">
						<span>
							<img src="jomor_html/img/blogimg/blog1/game4.png">
						</span>
						<span class="essay_more_gname_block">
							<div class="essay_more_gname">第四名：誰是牛頭王 TAKE 6!</div>
						<hr color="#96BDD2" width="85%" size="5" align="left">
							<div class="essay_more_gp">誰是牛頭王是一款悠閒但是卻刺激緊張的遊戲，有時候想害人反而會害到自己。</div>
						</span>
						...
						<hr color="#96BDD2" width="120px" size="5" align="left">
							<div class="essay_more_gp">
								<p>盡可能不要得到牌面上任何牌，因為牌上的每個牛頭都是-1分。</p>
							</div>
						</span>
						...
						<span class="blogimg_span">
							<img src="jomor_html/img/blogimg/blog1/game4-1.jpg" style="height: auto;width: 70%">
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gname">遊戲規則</div>
						<hr color="#96BDD2" width="30%" size="5" align="left">
							<div class="essay_more_gp">
								<p>每位玩家先會獲得10張手牌，然後從牌堆中翻出4張牌當作是起始檯面(起始牌列)。之後遊戲開始，玩家必須同時從10張手牌中打出一張牌，並依照遊戲規則將牌接到桌面上4列牌陣中的一列(看打出的牌與檯面上的牌數字大的往後面接)，若你該回合打出的牌成為某一牌列中的第6張，那麼就必須將前面的5張牌拿起(第6張將成為新一列牌頭)，而每一張牌上會有數量不等的牛頭。
								</p>
							</div>
						</span>
						<!--圖片改檔名"game1-2"的部分-->
						<span class="blogimg_span">
							<img src="jomor_html/img/blogimg/blog1/game4-2.jpg" style="height: auto;width: 70%">
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gp">
								<p>遊戲結束時，每位玩家數自己拿到幾顆牛頭，而得到最少牛頭的玩家就獲勝。這是一個會讓你非常有緊張感而且非常歡樂的派對遊戲，越多人玩越好玩，會充滿歡笑聲。
								</p>
							</div>
						</span>
					</div>
					...
					<div class="game_introduction">
						...
						<span class="game_introduction_span">
							...
							<hr color="#5D5D5D" width="66%" size="4">
							<div class="essay_more_gp">2-10人</div>
						</span>
						<span class="game_introduction_span">
