...
<header class="header_bg">
			...
			<div class="top">
				<table class="top_table">
					<tr class="top_tr">
						<td rowspan="2" class="top_td1" "><!--桌末狂歡logo-->
							<a href="../../index.php">
								<img src="../../jomor_html/img/jomorparty_logo.png" alt="logo" title="logo" width="65px" height="65px">
							</a>
							<span><a href="../../index.php"" class="pp">桌末狂歡</a></span>
							<div style="width:2px; height: 40px; background-color: #000;"></div>
						</td>
						...
						<?php
							if(isset($_SESSION['pri'])){
								...
								?>
								<td rowspan="2" class="top_notify_td02"><!--圓形頭貼照-->
									<img src="../user/photo/default.png" class="notify_img02">
								</td>
