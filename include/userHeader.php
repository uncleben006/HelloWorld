					...
					<tr class="top_tr">
							  ...
							  <div class="notify_fram">
							        <div class="notify_div01">
							            ...
							            <div class="notify_div_p">
							                <p>您於剛剛正式加入zxc123所創建的大家來揪團，
							提醒您9/27 14:00在天鵝咖啡館別遲到囉～:00在天鵝咖啡館別遲到囉～:00在天鵝咖啡館別遲到囉～:00在天鵝咖啡館別遲到囉～:00在天鵝咖啡館別遲到囉～:00在天鵝咖啡館別遲到囉～00在天鵝咖啡館別遲到囉～00在天鵝咖啡館別遲到囉～00在天鵝咖啡館別遲到囉～</p>
							            </div>
							        </div>
							        <div class="notify_div01">
							            <div class="notify_div_img">
							            ...
							            <div class="notify_div_p">
							                <p>您於剛剛正式加入yyyyyyy所創建的來來來桌遊，
							提醒您10/01 14:00在女巫店別遲到囉～</p>
							            </div>
							        </div>
							  </div>   
							</div>
						...
						<?php
							if(isset($_SESSION['pri'])){
								...
								?>
								<td rowspan="2" class="top_notify_td02"><!--圓形頭貼照-->
									<img src="photo/iMac-icon.png" class="notify_img02">
								</td>
