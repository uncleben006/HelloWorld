		...
		<section class="essay_section">
			...
			<div class="essay_block_div">
				<div class="essay_block">
					<img class="essay_cover" src="jomor_html/img/blogimg/blog_cover/game1.png">
					<div class="cover_bg">
						<p class="cover_bg_number">第一名</p>
						<p class="cover_name">德國心臟病</p>
					</div>
					<a href="blog_more1-1.php"><div class="eassay_cover_hover"></div></a>
				</div>
				<div class="essay_block">
					<img class="essay_cover" src="jomor_html/img/blogimg/blog_cover/game2.png">
					<div class="cover_bg">
						<p class="cover_bg_number">第二名</p>
						<p class="cover_name">妙語說書人</p>
					</div>
					<a href="blog_more1-2.php"><div class="eassay_cover_hover"></div></a>
				</div>
				<div class="essay_block">
					<img class="essay_cover" src="jomor_html/img/blogimg/blog_cover/game3.png">
					<div class="cover_bg">
						<p class="cover_bg_number">第三名</p>
						<p class="cover_name">閃靈快手</p>
					</div>
					<a href="blog_more1-3.php"><div class="eassay_cover_hover"></div></a>
				</div>
				<div class="essay_block">
					<img class="essay_cover" src="jomor_html/img/blogimg/blog_cover/game4.png">
					<div class="cover_bg2">
						<p class="cover_bg_number">第四名</p>
						<p class="cover_name">誰是牛頭王</p>
					</div>
					<a href="blog_more1-4.php"><div class="eassay_cover_hover"></div></a>
				</div>
				<div class="essay_block">
					<img class="essay_cover" src="jomor_html/img/blogimg/blog_cover/game5.png">
					<div class="cover_bg2">
						<p class="cover_bg_number">第五名</p>
						<p class="cover_name">矮人礦坑</p>
					</div>
					<a href="blog_more1-5.php"><div class="eassay_cover_hover"></div></a>
				</div>
				<div class="essay_block">
					<img class="essay_cover" src="jomor_html/img/blogimg/blog_cover/game6.png">
					<div class="cover_bg2">
						<p class="cover_bg_number">第六名</p>
						<p class="cover_name">從前從前</p>
					</div>
					<a href="blog_more1-6.php"><div class="eassay_cover_hover"></div></a>
				</div>
				<div class="essay_block">
					<img class="essay_cover" src="jomor_html/img/blogimg/blog_cover/game7.png">
					<div class="cover_bg2">
						<p class="cover_bg_number">第七名</p>
						<p class="cover_name">Bang!砰! </p>
					</div>
					<a href="blog_more1-7.php"><div class="eassay_cover_hover"></div></a>
				</div>
				<div class="essay_block">
					<img class="essay_cover" src="jomor_html/img/blogimg/blog_cover/game8.png">
					<div class="cover_bg2">
						<p class="cover_bg_number">第八名</p>
						<p class="cover_name">印加寶藏</p>
					</div>
					<a href="blog_more1-8.php"><div class="eassay_cover_hover"></div></a>
				</div>
				<div class="essay_block">
					<img class="essay_cover" src="jomor_html/img/blogimg/blog_cover/game9.png">
					<div class="cover_bg2">
						<p class="cover_bg_number">第九名</p>
						<p class="cover_name">化裝舞會</p>
					</div>
					<a href="blog_more1-9.php"><div class="eassay_cover_hover"></div></a>
				</div>
				<div class="essay_block2">
					<img class="essay_cover" src="jomor_html/img/blogimg/blog_cover/game10.png">
					<div class="cover_bg2">
						<p class="cover_bg_number">第十名</p>
						<p class="cover_name">凶煞迴廊</p>
					</div>
					<a href="blog_more1-10.php"><div class="eassay_cover_hover"></div></a>
				</div>
				<!--分享區塊-->
