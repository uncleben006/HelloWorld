	...
	<body id="body0">
		...
		<section class="essay_section">
			<div class="essay_path_div"> <!--路徑-->
				...
				<span class="path_mark">></span>
				<span><a class="path_p" href="blog_more1-8.php">印加寶藏介紹</a></span>
			</div>
				...
				<div class="essay_green_line"><!--文章綠線-->
					<div><!--文章上半部標題日期等資訊-->
						...
						<span class="essay_title_span"><!--文章標題與時間-->
							...
							<div class="essay_title_p2">2016.10.20 | 十大派對桌遊介紹 | 印加寶藏</div>
						</span>
						<!--分享區塊-->
						<span class="essay_more_share_span">
							...
							<div class="essay_more_share_bt_div">
								<!--fb分享按鈕-->
								<a href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent('http://www.jomorparty.com/blog_more1-8.php'))));">
					...
					<div class="essay_more_words">
						<span>
							<img src="jomor_html/img/blogimg/blog1/game8.png">
						</span>
						<span class="essay_more_gname_block">
							<div class="essay_more_gname">第八名：印加寶藏 INCAN GOLD</div>
						<hr color="#96BDD2" width="85%" size="5" align="left">
							<div class="essay_more_gp">玩家在遊戲中代表一群探險隊，到印加古文明尋找黃金及寶藏，但在探險過程中，可能會因為各種災難的襲擊而失去寶藏，因此玩家們需投票表決，要回到帳棚帶回目前所擁有的寶藏，還是選擇放手一搏，繼續探險帶回更多寶藏，在短短五天的探險時間，究竟誰會在這冒險旅途中滿載而歸呢？</div>
						</span>
						...
						<hr color="#96BDD2" width="120px" size="5" align="left">
							<div class="essay_more_gp">
								<p>當所有玩家皆返回營地，或同樣的災難卡出現2張，該回合結束。遊戲進行5個回合後，遊戲結束，分數最高的玩家獲勝。</p>
							</div>
						</span>
						...
						<hr color="#96BDD2" width="140px" size="5" align="left">
							<div class="essay_more_gp">
								<p>神殿卡5張、神器卡5張、決策卡16張(包括8張繼續探險卡及8張返回營地卡)、探險卡30張、帳篷8張、寶物(包括綠松石、黑曜石及黃金)</p>
							</div>
						</span>
						<!--圖片改檔名"game1-1"的部分-->
						<span class="blogimg_span">
							<img src="jomor_html/img/blogimg/blog1/game8-1.jpg" style="height: auto;width: 70%">
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gname">遊戲規則</div>
						<hr color="#96BDD2" width="30%" size="5" align="left">
							<div class="essay_more_gp">
								<p>每位玩家會有1張冒險卡、1張撤退卡和一座帳篷。每一回合開始時，大家會同時決定自己是否要參與冒險:「回到營地」或「繼續冒險」。</p>
							</div>
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gp">
								<p>是個將運氣發揮到極致的遊戲，若想提早回帳篷就會希望其它人遇到災難，但選擇繼續探險的玩家就會想拿到更多寶藏，在遊戲尚未結束之前都無法確認自己選擇是否是對的，因為沒有複雜的遊戲規則，是一款很好上手的派對遊戲喔！
								</p>
							</div>
						</span>
					</div>
					...
					<div class="game_introduction">
						...
						<span class="game_introduction_span">
							...
							<hr color="#5D5D5D" width="66%" size="4">
							<div class="essay_more_gp">3-8人</div>
						</span>
						<span class="game_introduction_span">
