	...
	<body id="body0">
		...
		<section class="essay_section">
			<div class="essay_path_div"> <!--路徑-->
				...
				<span class="path_mark">></span>
				<span><a class="path_p" href="blog_more1-6.php">從前從前介紹</a></span>
			</div>
				...
				<div class="essay_green_line"><!--文章綠線-->
					<div><!--文章上半部標題日期等資訊-->
						...
						<span class="essay_title_span"><!--文章標題與時間-->
							...
							<div class="essay_title_p2">2016.10.20 | 十大派對桌遊介紹 | 從前從前</div>
						</span>
						<!--分享區塊-->
						<span class="essay_more_share_span">
							...
							<div class="essay_more_share_bt_div">
								<!--fb分享按鈕-->
								<a href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent('http://www.jomorparty.com/blog_more1-6.php'))));">
					...
					<div class="essay_more_words">
						<span>
							<img src="jomor_html/img/blogimg/blog1/game6.png">
						</span>
						<span class="essay_more_gname_block">
							<div class="essay_more_gname">第六名：從前從前 ONCE UPON A TIME</div>
						<hr color="#96BDD2" width="85%" size="5" align="left">
							<div class="essay_more_gp">遊戲中玩家們各別擔任說故事的角色，需利用手上握有的故事元素來編成一段故事，並想辦法將故事導向自己所抽中的結局。</div>
						</span>
						...
						<hr color="#96BDD2" width="140px" size="5" align="left">
							<div class="essay_more_gp">
								<p>共165張紙牌(84張故事元素卡、21張故事中斷卡、55張結局卡及5張空白卡)</p>
							</div>
						</span>
						<!--圖片改檔名"game1-1"的部分-->
						<span class="blogimg_span">
							<img src="jomor_html/img/blogimg/blog1/game6-1.jpg" style="height: auto;width: 70%">
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gname">遊戲規則</div>
						<hr color="#96BDD2" width="30%" size="5" align="left">
							<div class="essay_more_gp">
								<p>選一玩家為起始玩家開始說故事，故事內容不侷限於手上的卡片。每當在故事中提到故事卡中的元素時，便可將此元素卡打出置於面前，其它玩家在這時候可利用手中相對應的卡片去中斷正在說故事的玩家，最後將手上故事卡出完並順利連接到自己的結局卡即為贏家。</p>
							</div>
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gp">
								<p>在遊戲進行中，需要玩家發揮各式各樣的想像，與大家合力編出一段歡樂又富有創意的故事，此遊戲大多不重在結果，而在於大家一起說故事的樂趣，相當適合在家庭聚會中玩此款遊戲。
								</p>
							</div>
						</span>
					</div>
					...
					<div class="game_introduction">
						...
						<span class="game_introduction_span">
							...
							<hr color="#5D5D5D" width="66%" size="4">
							<div class="essay_more_gp">2-6人</div>
						</span>
						<span class="game_introduction_span">
