	...
	<body id="body0">
		...
		<section class="essay_section">
			<div class="essay_path_div"> <!--路徑-->
				...
				<span class="path_mark">></span>
				<span><a class="path_p" href="blog_more1-5.php">矮人礦坑介紹</a></span>
			</div>
				...
				<div class="essay_green_line"><!--文章綠線-->
					<div><!--文章上半部標題日期等資訊-->
						...
						<span class="essay_title_span"><!--文章標題與時間-->
							...
							<div class="essay_title_p2">2016.10.20 | 十大派對桌遊介紹 | 矮人礦坑</div>
						</span>
						<!--分享區塊-->
						<span class="essay_more_share_span">
							...
							<div class="essay_more_share_bt_div">
								<!--fb分享按鈕-->
								<a href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent('http://www.jomorparty.com/blog_more1-5.php'))));">
					...
					<div class="essay_more_words">
						<span>
							<img src="jomor_html/img/blogimg/blog1/game5.png">
						</span>
						<span class="essay_more_gname_block">
							<div class="essay_more_gname">第五名：矮人礦坑 SABOTEUR</div>
						<hr color="#96BDD2" width="85%" size="5" align="left">
							<div class="essay_more_gp">矮人礦坑是一款規則簡單、容易上手的派對陣營遊戲，很適合剛入門的新手玩。</div>
						</span>
						...
						<hr color="#96BDD2" width="140px" size="5" align="left">
							<div class="essay_more_gp">
								<p>40張坑道牌、1張起點牌、3張終點牌、27張行動牌、28張金礦牌、11張陣營牌</p>
							</div>
						</span>
						<!--圖片改檔名"game1-1"的部分-->
						<span class="blogimg_span">
							<img src="jomor_html/img/blogimg/blog1/game5-1.jpg" style="height: auto;width: 70%">
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gname">遊戲規則</div>
						<hr color="#96BDD2" width="30%" size="5" align="left">
							<div class="essay_more_gp">
								<p>遊戲中玩家們將要扮演成兩種不同的矮人。其中一種是淘金的好矮人，他們將要開拓坑道去尋找金礦；另一種則是在路上想辦法進行阻礙的壞矮人。自己的身分只有自己知道，大家都不會知道彼此的身分，所以你只能由出牌的過程來猜測誰是好人誰是壞人。需要絞盡腦汁幫助自己的同伴以及想辦法隱藏自己的角色，用心機使用功能牌來陷害敵方陣營或是保護隊友是這款遊戲最大的特點。最後如果好矮人成功的開通了前往金礦的坑道，他們將得到金礦作為獎賞，而壞矮人將什麼都沒有；不過如果好矮人失敗了沒挖到金礦，則是壞矮人得到金礦。</p>
							</div>
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gp">
								<p>每位玩家所扮演的角色(陣營)，只有在最後分金礦的時候才會揭曉。每個回合都會重新抽角色，而遊戲進行三回合後結束獲得最多金礦的玩家就獲勝。這是個可以10個好友一起同樂的派對遊戲。
								</p>
							</div>
						</span>
					</div>
					...
					<div class="game_introduction">
						...
						<span class="game_introduction_span">
							...
							<hr color="#5D5D5D" width="66%" size="4">
							<div class="essay_more_gp">3-10人</div>
						</span>
						<span class="game_introduction_span">
