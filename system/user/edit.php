				...
				<form method="post" enctype="multipart/form-data">
					<div class="edit_white">
						...
						<table class="edit_table">
							<tr>
								<td colspan="2" ><div style="color:red"><?php if(isset($errMsg)){echo $errMsg;} ?></div></td>
							</tr>
							<tr class="edit_tr"><!--tr-->
							...
							<!--第五行-->
							<tr>
								<td class="edit_td000" colspan="3">輸入原密碼儲存資料</td>
							</tr>
							<tr class="edit_tr2">
								<td class="edit_td3">
								<!--舊密碼-->
									<div class="edit_text_divpp">
