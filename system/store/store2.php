	...
	<body id="body0">
		...
		<section>
				...
				<?php
					if(isset($_SESSION['account'])){
						...
						if($userAccount['pri']==3){
							?>
							<a href="uploadStore.php" class="map_myButton5">輸入店家資訊</a>
							<?php						
						}
					}					
				?>
			...
			<div class="store_yellow">
				...
				<span class="store_push">
					<img class="aside_store_img" src="photo/taipei37.jpg" width="195px" height="195px" onclick="my_scroll('store2.php?no=135&storePlace=臺北市'); return false">
					<span class="store_img_hover" onclick="my_scroll('store2.php?no=135&storePlace=臺北市'); return false">
					 漫果子(公館店)
					</span>
				</span>
				<span class="store_push">
