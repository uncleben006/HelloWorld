		...
		<section>
			<div class="aboutus_photo_div1"><!--個人介紹表格-->
				<div class="aboutus_tr"><!--tr-->
					...
					<div class="work_td">
						<div class="work1">
							<p class="work_p1">&nbsp;&nbsp;&nbsp;預算管理<br>&nbsp;&nbsp;&nbsp;企劃撰寫<br>專案進度管理</p>
						</div>
					</div>
				</div>					
			</div>
			<div class="aboutus_photo_div2"><!--個人介紹表格-->
				<div class="aboutus_tr"><!--tr-->
					...
					<div class="work_td">
						<div class="work1">
							<p class="work_p2">&nbsp;&nbsp;&nbsp;網站架構設計<br>&nbsp;&nbsp;&nbsp;前端語言撰寫</p>
						</div>
					</div>
				</div>					
			</div>
			<div class="aboutus_photo_div2"><!--個人介紹表格-->
				<div class="aboutus_tr"><!--tr-->
					...
					<div class="work_td">
						<div class="work1">
							<p class="work_p2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;系統設計<br>&nbsp;&nbsp;&nbsp;後端語言撰寫</p>
						</div>
					</div>
				</div>					
			</div>
			<div class="aboutus_photo_div2"><!--個人介紹表格-->
				<div class="aboutus_tr"><!--tr-->
					...
					<div class="work_td">
						<div class="work1">
							<p class="work_p2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;網路行銷<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;活動企劃</p>
						</div>
					</div>
				</div>					
			</div>
			<div class="aboutus_photo_div3"><!--個人介紹表格-->
				<div class="aboutus_tr"><!--tr-->
					...
					<div class="work_td">
						<div class="work2">
							<p class="work_p2">&nbsp;&nbsp;&nbsp;圖文美工編輯<br>&nbsp;&nbsp;&nbsp;網站介面設計</p>
						</div>
					</div>
				</div>					
			</div>
