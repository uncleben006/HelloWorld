	...
	<body id="body0">
		...
		<section class="essay_section">
			<div class="essay_path_div"> <!--路徑-->
				...
				<span class="path_mark">></span>
				<span><a class="path_p" href="blog_more1-10.php">凶煞迴廊介紹</a></span>
			</div>
				...
				<div class="essay_green_line"><!--文章綠線-->
					<div><!--文章上半部標題日期等資訊-->
						...
						<span class="essay_title_span"><!--文章標題與時間-->
							...
							<div class="essay_title_p2">2016.10.20 | 十大派對桌遊介紹 | 凶煞迴廊</div>
						</span>
						<!--分享區塊-->
						<span class="essay_more_share_span">
							...
							<div class="essay_more_share_bt_div">
								<!--fb分享按鈕-->
								<a href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent('http://www.jomorparty.com/blog_more1-10.php'))));">
					...
					<div class="essay_more_words">
						<span>
							<img src="jomor_html/img/blogimg/blog1/game10.png">
						</span>
						<span class="essay_more_gname_block">
							<div class="essay_more_gname">第十名：凶煞迴廊 FEARSOME FLOORS</div>
						<hr color="#96BDD2" width="85%" size="5" align="left">
							<div class="essay_more_gp">這款遊戲是描述玩家們被邀請到一個奇怪的古堡，但在進入古堡後，卻發現入口處被擋住了！怪物漸漸逼近，要如何逃出古堡脫離魔爪呢？</div>
						</span>
						...
						<hr color="#96BDD2" width="120px" size="5" align="left">
							<div class="essay_more_gp">
								<p>玩家要想盡辦法避開怪物的視線，讓代表自己的人物順利從起點走到終點即可獲勝。</p>
							</div>
						</span>
						...
						<hr color="#96BDD2" width="140px" size="5" align="left">
							<div class="essay_more_gp">
								<p>7個地板指示物、8個怪物移動板、1個起始玩家指示物、25個玩家指示物、1張怪物組合板</p>
							</div>
						</span>
						<!--圖片改檔名"game1-1"的部分-->
						<span class="blogimg_span">
							<img src="jomor_html/img/blogimg/blog1/game10-1.jpg" style="height: auto;width: 70%">
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gname">遊戲規則</div>
						<hr color="#96BDD2" width="30%" size="5" align="left">
							<div class="essay_more_gp">
								<p>玩家移動場內人物，依照棋子上面步數移動，移動完就翻面，一回合只能進場一隻人物。每回合當全部玩家都移動結束後，則換怪物移動。重複上述兩動作直至遊戲結束。當剩下一位玩家的指示物沒有逃出時，該玩家就獲勝。若第二階段所有樓層中的玩家指示物皆被殺光了(版圖上無棋子遊戲結束)，此時最先逃出最多數量的玩家獲勝。</p>
							</div>
						</span>
						<!--圖片改檔名"game1-2"的部分-->
						<span class="blogimg_span">
							<img src="jomor_html/img/blogimg/blog1/game10-3.jpg" style="height: auto;width: 70%">
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gp">
								<p>兇煞迴廊是個需要動腦思考的歡樂派對遊戲。就像玩象棋一樣，每個人的一舉一動都會影響到最後的結果。玩家不只要想盡辦法讓自己的人物逃出，也須想辦法佈局陷害別人，整個遊戲玩起來充滿心機與刺激感！
								</p>
							</div>
						</span>
					</div>
					...
					<div class="game_introduction">
						<span class="game_introduction_span">
							...
							<div class="essay_more_gp">13歲以上</div>
						</span>
						<span class="game_introduction_span">
							<div class="essay_more_gname">遊玩人數</div>
							<hr color="#5D5D5D" width="66%" size="4">
							<div class="essay_more_gp">2-7人</div>
						</span>
						<span class="game_introduction_span">
							<div class="essay_more_gname">遊玩時間</div>
							<hr color="#5D5D5D" width="66%" size="4">
							<div class="essay_more_gp">45分鐘</div>
						</span>
					</div>
					<div><!--遊戲介紹列表圖片-->
