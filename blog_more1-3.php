	...
	<body id="body0">
		...
		<section class="essay_section">
			<div class="essay_path_div"> <!--路徑-->
				...
				<span class="path_mark">></span>
				<span><a class="path_p" href="blog_more1-3.php">閃靈快手介紹</a></span>
			</div>
				...
				<div class="essay_green_line"><!--文章綠線-->
					<div><!--文章上半部標題日期等資訊-->
						...
						<span class="essay_title_span"><!--文章標題與時間-->
							...
							<div class="essay_title_p2">2016.10.20 | 十大派對桌遊介紹 | 閃靈快手</div>
						</span>
						<!--分享區塊-->
						<span class="essay_more_share_span">
							...
							<div class="essay_more_share_bt_div">
								<!--fb分享按鈕-->
								<a href="javascript: void(window.open('http://www.facebook.com/share.php?u='.concat(encodeURIComponent('http://www.jomorparty.com/blog_more1-3.php'))));">
					...
					<div class="essay_more_words">
						<span>
							<img src="jomor_html/img/blogimg/blog1/game3.png">
						</span>
						<span class="essay_more_gname_block">
							<div class="essay_more_gname">第三名：閃靈快手 HGEISTESBLITZ</div>
						<hr color="#96BDD2" width="85%" size="5" align="left">
							<div class="essay_more_gp">閃靈快手是一款比速度跟準確的反應類桌遊，沒有思考完全會很容易抓錯物品。</div>
						</span>
						...
						<hr color="#96BDD2" width="140px" size="5" align="left">
							<div class="essay_more_gp">
								<p>60張卡牌、幽靈巴頓(白色)、椅子(紅色)、書本(藍色)、酒瓶(綠色)、老鼠(灰色)</p>
							</div>
						</span>
						<!--圖片改檔名"game1-1"的部分-->
						<span class="blogimg_span">
							<img src="jomor_html/img/blogimg/blog1/game3-1.jpg" style="height: auto;width: 70%">
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gname">遊戲規則</div>
						<hr color="#96BDD2" width="30%" size="5" align="left">
							<div class="essay_more_gp">
								<p>快、狠、準，是閃靈快手中最重要的三個勝利因素。反應越快還有抓對物品，才會獲得勝利。
									<br>規則只有兩個：
									<br>1.有與卡牌完全相符的(顏色物品)就抓。
									<br>2.完全沒出現在卡牌上的就抓。
									<br>
									<br>雖然要用腦但玩起來非常輕鬆而且也很刺激。每從牌堆中翻一張牌就要搶奪一次物品，但是又不能亂抓，搶到正確的物品就能拿到當回合的牌(抓到正確的物品可以獲得一張牌，但抓錯牌要將自己的牌給對的人)。每次一翻牌就要大聲尖叫然後與朋友們爭奪物品，考驗辨識正確物品的速度、還有誰的反應最快。
								</p>
							</div>
						</span>
						<!--圖片改檔名"game1-2"的部分-->
						<span class="blogimg_span">
							<img src="jomor_html/img/blogimg/blog1/game3-2.jpg" style="height: auto;width: 70%">
						</span>
						<span class="essay_more_artical_block">
							<div class="essay_more_gp">
								<p>是一款非常簡單而且很好上手的派對桌遊。除了適合桌遊新手入門之外，也很適合朋友之間互相比較誰的反應力比較快。遊戲結束時誰有最多的牌就算勝利。
								</p>
							</div>
						</span>
					</div>
					...
					<div class="game_introduction">
						...
						<span class="game_introduction_span">
							...
							<hr color="#5D5D5D" width="66%" size="4">
							<div class="essay_more_gp">2-8人</div>
						</span>
						<span class="game_introduction_span">
							<div class="essay_more_gname">遊玩時間</div>
							<hr color="#5D5D5D" width="66%" size="4">
							<div class="essay_more_gp">20-30分鐘</div>
						</span>
					</div>
					<div><!--遊戲介紹列表圖片-->
